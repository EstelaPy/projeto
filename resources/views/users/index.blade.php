...
<div class="d-flex justify-content-between ">
    ...
    <div class="space-buttons">
        <button type="button" class="btn btn-success btn-success-space" data-bs-toggle="modal" data-bs-target="#exampleModal">Cadastrar Usuario</button>
    </div>
</div>
    ...
    <li class="list-group-item">
      ...
      <div class="separator">
        ...
        <div class="buttons_list">
          <div class="btn_rigth"><button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#exampleModal">Editar</button></div>
        </div>
      </div>
    </li>
@endforeach
        ...
        <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="password" class="form-control" placeholder="Digite sua senha" name="confirm_password" id="confirm_password"> 
              </div>
            </div>
